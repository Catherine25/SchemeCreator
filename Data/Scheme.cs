...
namespace SchemeCreator.Data {
    class Scheme {
        ...
        //         if (g.type == Constants.GateEnum.IN) {
        ...
        //                 }
        //         }
        //         else if (g.type != Constants.GateEnum.OUT) {
        ...
        //     foreach (Gate g in gateController.gates) {
        //         if(g.type == Constants.GateEnum.OUT) {
        ...
        //                 }
        //         }
        //         else if (g.type != Constants.GateEnum.IN) {
        ...
        //     if (gate.type == (int)Constants.GateEnum.IN || gate.type == Constants.GateEnum.OUT) {
        ...
        //     if (gate.type != Constants.GateEnum.IN && gate.type != Constants.GateEnum.OUT) {
